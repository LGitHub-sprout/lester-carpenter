/**************************** Rock Paper Scissors App ***
  ...
  From @barry on TOP Discord: 
    function to get user choice
    function to get computer choice
    function to run game using the functions above
    function that loops x times and runs function above
    Finally run the function above
